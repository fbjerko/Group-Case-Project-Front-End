...
class MatchesForm extends React.Component {
    ...
    sendMatch = () => {
        ...
        xhttp.send(
            JSON.stringify({
                playersIds: this.state.selectedPlayers,
        ...
        return (
            <div className="create-match-container">
                ...
                <div style={{marginRight: '50px'}}>
                    ...
                    <br></br>
                    <p>Match date</p>
                    <input onChange={this.updateInput} value={this.state.match_date} type="date"
                           placeholder="Write a match_date" id="match_date"/>
                    <br></br>
                    <br></br>
                    <p>Season</p>
                    ...
                    <table>
                        ...
                        {this.state.team_1_players.map((player) => {
                            if (this.state.selectedPlayers.indexOf(player[0].toString()) != -1) {
                                ...
                                return (<tr id={player[0]} style={{color: 'yellow'}} key={player[0]}
                    ...
                    <table>
                        ...
                        {this.state.team_2_players.map((player) => {
                            if (this.state.selectedPlayers.indexOf(player[0].toString()) != -1) {
                                ...
                                return (<tr id={player[0]} style={{color: 'white'}} key={player[0]}
                                            onClick={this.selectPlayer}>
                                        <td id={player[0]}>{player[1]}</td>
                                        <td id={player[0]}>{player[2]}</td>
                                    </tr>
