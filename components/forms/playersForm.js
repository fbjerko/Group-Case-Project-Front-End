...
class PlayersForm extends Component {
  ...
  sendPlayer = () => {
    this.setState({
      loading: <Loading icon={true} text={"Creating player..."} />
    });
      ...
      if (xhttp.readyState == XMLHttpRequest.DONE) {
        if (xhttp.status == 200) {
          this.setState({
            status: "Created",
            loading: (
              <Loading icon={false} text={"Successfull " + this.props.edit} />
            )
          });
          ...
          this.setState({
            ...
            loading: (
              <Loading icon={false} text={"Failed to " + this.props.edit} />
            )
          });
        }
      }
      ...
      return (
        ...
        <div className="info-container">
          <div >
            ...
            <div className="top">
              <h2>
                {i18n.t("PLAYER", { lng }) + " " + i18n.t("INFO", { lng })}
              </h2>
            </div>
            ...
            <SearchField
              ...
              handleChange={this.updateSearchFieldPerson}
            />
            <br />
            <br />
            ...
            <SearchField
              ...
              handleChange={this.updateSearchFieldTeam}
